...
export default function Guide({ navigation }) {
  const Guide = ({ title, syntax, example, description }) => {
    return (
      <View style={globalStyles.guideFeature}>
        <Text style={globalStyles.guideFeature_title}>{title}</Text>
  ...
  return (
    <View style={globalStyles.container}>
      ...
      <Guide
        ...
        description="Wiki sẽ gợi ý các phim liên quan đến thể loại bạn nhập vào.
