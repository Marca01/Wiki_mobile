...
const data_guide = [
  {
    ...
    syntax: ":google + nội dung muốn tìm",
    example: "':google chatbot là gì'",
  ...
  },
  {
    ...
    example: "':wiki xe hơi'",
    description:
      "Wiki sẽ tìm giúp bạn thông tin đã được tóm gọn lại bởi wikipedia.",
  },
  {
    title: "Tính toán các phép tính đơn giản",
    syntax:
      "Bạn có thể hỏi các câu liên quan tới tính toán như '1 + 2 bằng mấy' hoặc chỉ đơn giản là nhắn '2 * 3'",
    example: "'23 * 78 bằng mấy?'",
    description:
      "Wiki sẽ giúp bạn tính toán các phép tính tưởng chừng như không hề khó mà lại khó không tưởng 😁.",
  },
  {
  ...
  },
  {
    ...
    syntax: ":film + thể loại phim",
    example: "':film superhero'",
    description:
  ...
  {
    title: "Rút gọn link",
    syntax: ":surl + link cần rút gọn",
    example: "':surl https://github.com/Marca01/Wiki_mobile/tree/Backend'",
    description:
      "Wiki sẽ giúp bạn rút gọn những đường link quá dài để có thể dễ dàng nhớ và copy",
  },
  {
    title: "Đổi tiền",
    syntax:
      ":cc + đơn vị tiền tệ muốn đổi, đơn vị tiền tệ muốn đổi sang, số lượng",
    example: "':cc usd, vnd, 100'",
    description:
      "Wiki sẽ giúp bạn chuyển đổi tiền tệ dựa trên tỉ giá được cập nhật hằng ngày",
  },
];
    ...
    <View style={globalStyles.container}>
      <View style={globalStyles.guideHeader}>
        <View style={globalStyles.guideHeader_title}>
          <Text style={globalStyles.guideFeature_header}>
            Đây là trang hướng dẫn các tính năng của wiki chatbot
          </Text>
        </View>
      ...
      <Accordion
        ...
        renderHeader={(section) => (
          <Text style={globalStyles.guideFeature_title}>{section.title}</Text>
        )}
