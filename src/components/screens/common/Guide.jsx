...
const data_guide = [
  ...
  },
  {
    ...
    description: "Wiki sẽ giúp bạn rút gọn những đường link quá dài để có thể dễ dàng nhớ và copy"
  },
  {
    title: "Đổi tiền",
    syntax: ":cc + đơn vị tiền tệ muốn đổi, đơn vị tiền tệ muốn đổi sang, số lượng",
    example: "':cc usd, vnd, 100'",
    description: "Wiki sẽ giúp bạn chuyển đổi tiền tệ dựa trên tỉ giá được cập nhật hằng ngày"
  }
];
    ...
    <View style={globalStyles.container}>
      <View style={globalStyles.guideHeader}>
        <View style={globalStyles.guideHeader_title}>
          <Text style={globalStyles.guideFeature_header}>Đây là trang hướng dẫn các tính năng của wiki chatbot</Text>
        </View>
